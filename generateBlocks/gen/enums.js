export default {
    ...
    lootTable: [
        ...
        ["ANCIENT_CITY_ICE_BOX", "ANCIENT_CITY_ICE_BOX"], 
        ...
        ["ZOMBIE_VILLAGER", "ZOMBIE_VILLAGER"], 
        ["ZOMBIFIED_PIGLIN", "ZOMBIFIED_PIGLIN"], 
        ["ARMORER_GIFT", "ARMORER_GIFT"], 
        ["BUTCHER_GIFT", "BUTCHER_GIFT"], 
        ["CARTOGRAPHER_GIFT", "CARTOGRAPHER_GIFT"], 
        ["CAT_MORNING_GIFT", "CAT_MORNING_GIFT"], 
        ["CLERIC_GIFT", "CLERIC_GIFT"], 
        ["FARMER_GIFT", "FARMER_GIFT"], 
        ["FISHERMAN_GIFT", "FISHERMAN_GIFT"], 
        ["FISHING", "FISHING"], 
        ["FISHING_FISH", "FISHING_FISH"], 
        ["FISHING_JUNK", "FISHING_JUNK"], 
        ["FISHING_TREASURE", "FISHING_TREASURE"], 
        ["FLETCHER_GIFT", "FLETCHER_GIFT"], 
        ["LEATHERWORKER_GIFT", "LEATHERWORKER_GIFT"], 
        ["LIBRARIAN_GIFT", "LIBRARIAN_GIFT"], 
        ["MASON_GIFT", "MASON_GIFT"], 
        ["SHEPHERD_GIFT", "SHEPHERD_GIFT"], 
        ["TOOLSMITH_GIFT", "TOOLSMITH_GIFT"], 
        ["WEAPONSMITH_GIFT", "WEAPONSMITH_GIFT"], 
        ["SNIFFER_DIGGING", "SNIFFER_DIGGING"], 
        ["PIGLIN_BARTERING", "PIGLIN_BARTERING"], 
        ["DESERT_WELL_ARCHAEOLOGY", "DESERT_WELL_ARCHAEOLOGY"], 
        ["DESERT_PYRAMID_ARCHAEOLOGY", "DESERT_PYRAMID_ARCHAEOLOGY"], 
        ["TRAIL_RUINS_ARCHAEOLOGY_COMMON", "TRAIL_RUINS_ARCHAEOLOGY_COMMON"], 
        ["TRAIL_RUINS_ARCHAEOLOGY_RARE", "TRAIL_RUINS_ARCHAEOLOGY_RARE"], 
        ["OCEAN_RUIN_WARM_ARCHAEOLOGY", "OCEAN_RUIN_WARM_ARCHAEOLOGY"], 
        ["OCEAN_RUIN_COLD_ARCHAEOLOGY", "OCEAN_RUIN_COLD_ARCHAEOLOGY"], 
        ["SHEEP", "SHEEP"], 
        ["SHEEP_BLACK", "SHEEP_BLACK"], 
        ["SHEEP_BLUE", "SHEEP_BLUE"], 
        ["SHEEP_BROWN", "SHEEP_BROWN"], 
        ["SHEEP_CYAN", "SHEEP_CYAN"], 
        ["SHEEP_GRAY", "SHEEP_GRAY"], 
        ["SHEEP_GREEN", "SHEEP_GREEN"], 
        ["SHEEP_LIGHT_BLUE", "SHEEP_LIGHT_BLUE"], 
        ["SHEEP_LIGHT_GRAY", "SHEEP_LIGHT_GRAY"], 
        ["SHEEP_LIME", "SHEEP_LIME"], 
        ["SHEEP_MAGENTA", "SHEEP_MAGENTA"], 
        ["SHEEP_ORANGE", "SHEEP_ORANGE"], 
        ["SHEEP_PINK", "SHEEP_PINK"], 
        ["SHEEP_PURPLE", "SHEEP_PURPLE"], 
        ["SHEEP_RED", "SHEEP_RED"], 
        ["SHEEP_WHITE", "SHEEP_WHITE"], 
        ["SHEEP_YELLOW", "SHEEP_YELLOW"]
    ], 
    biome: [
        ["OCEAN", "OCEAN"], 
        ["PLAINS", "PLAINS"], 
